...
(function () {
  ...
  window.Api = {
    ...
    updateCategory: function (id, name) { return callGas('updateCategory', { id: id, name: name }); },
    ...
    updateTripItem: function (tripId, name, tagId) { return callGas('updateTripItem', { trip_id: tripId, name: name, tag_id: tagId }); },
